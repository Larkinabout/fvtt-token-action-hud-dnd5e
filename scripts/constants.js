...
export const GROUP = {
  ...
  passiveEffects: { id: "passive-effects", name: "DND5E.EFFECT.Category.Passive", type: "system" },
  ...
  temporaryEffects: { id: "temporary-effects", name: "DND5E.EFFECT.Category.Temporary", type: "system" },
